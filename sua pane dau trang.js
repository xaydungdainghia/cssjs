...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='https://goo.gl/FrcrMe' target='_blank'><img src='http://imageshack.com/a/img922/4904/NExWRF.jpg' width='500px'/><br/>bảng hiệu quảng cáo</a>.tại thành phố hồ chí minh. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
